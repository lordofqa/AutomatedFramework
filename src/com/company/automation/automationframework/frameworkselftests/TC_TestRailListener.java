...
@DataSource(source = "com/company/automation/automationframework/frameworkselftests/data/TC_TestRailListener.csv")

public class TC_TestRailListener 
{
 ...
 public void testTestRailListener  (HashMap<String, String> csv)  
 {
